...
try:
    with open('../struqture_py/__version__.py') as f:
        lines = f.readlines()
...
htmlhelp_basename = 'struqture_pydoc'
...
latex_documents = [
    (master_doc, 'struqture_py.tex', 'struqture_py Documentation',
...
man_pages = [
    (master_doc, 'struqture_py', 'struqture_py Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'struqture_py', 'struqture_py Documentation',
     author, 'struqture_py', 'HQS Quantum Simulations package for representing physical operators.',
     'Miscellaneous'),
]
