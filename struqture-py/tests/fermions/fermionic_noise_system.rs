...
fn test_default_partialeq_debug_clone() {
    ...
    Python::attach(|py| {
        ...
        let new_system = binding.cast::<FermionLindbladNoiseSystemWrapper>().unwrap();
...
fn fermion_system_test_add_operator_product_remove() {
    ...
    pyo3::Python::attach(|py| {
        ...
        let system = binding.cast::<FermionLindbladNoiseSystemWrapper>().unwrap();
        system
            .call_method1("add_operator_product", (("c0a0", "c0a0"), 0.1))
            .unwrap();
        system
...
fn test_jordan_wigner() {
    ...
    pyo3::Python::attach(|py| {
        ...
        let number_modes = usize::extract(
            flns.call_method0("current_number_modes")
                .unwrap()
                .as_borrowed(),
        )
        .unwrap();
