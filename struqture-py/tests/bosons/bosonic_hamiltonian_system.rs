...
// helper functions
fn new_system(py: Python, number_bosons: Option<usize>) -> &PyCell<BosonHamiltonianSystemWrapper> {
...
// helper functions
fn new_bosonic_system(py: Python, number_bosons: Option<usize>) -> &PyCell<BosonSystemWrapper> {
