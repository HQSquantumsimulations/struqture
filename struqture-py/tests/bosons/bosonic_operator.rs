...
// helper functions
fn new_system(py: Python) -> Bound<BosonOperatorWrapper> {
    let system_type = py.get_type::<BosonOperatorWrapper>();
    system_type
        .call0()
        .unwrap()
        .cast::<BosonOperatorWrapper>()
        .unwrap()
        .to_owned()
}
...
fn test_default_partialeq_debug_clone() {
    ...
    Python::attach(|py| {
        ...
        assert_eq!(
            ...
            "BosonOperatorWrapper { internal: BosonOperator { internal_map: {} } }"
        );
...
/// Test number_bosons function of BosonOperator
#[test]
...
fn boson_system_test_set_get() {
    ...
    pyo3::Python::attach(|py| {
        ...
        system.cast::<BosonOperatorWrapper>().unwrap();
