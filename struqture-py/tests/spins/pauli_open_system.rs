...
fn new_system(py: Python) -> Bound<PauliLindbladOpenSystemWrapper> {
    ...
    system_type
        .call0()
        .unwrap()
        .downcast::<PauliLindbladOpenSystemWrapper>()
        .unwrap()
        .to_owned()
}
...
fn spin_system_test_add_operator_product_remove_system() {
    ...
    pyo3::Python::with_gil(|py| {
        ...
        system.downcast::<PauliLindbladOpenSystemWrapper>().unwrap();
        system
...
fn test_default_partialeq_debug_clone() {
    ...
    Python::with_gil(|py| {
        ...
        spin_system
            ...
            .unwrap();
        let comparison =
            bool::extract_bound(&comp_op.call_method1("__eq__", (spin_system,)).unwrap()).unwrap();
        assert!(comparison);
...
fn test_pprint() {
    ...
    pyo3::Python::with_gil(|py| {
        ...
        sys.call_method1("system_add_operator_product", ("1Z27Y", 1.0))
            .unwrap();
        sys.call_method1("noise_add_operator_product", (("1Z27iY", "3X"), 1.2))
            .unwrap();
        sys.call_method1("noise_add_operator_product", (("3X", "3X"), 0.2))
            .unwrap();
