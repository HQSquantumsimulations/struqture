...
fn spin_system_test_set_get() {
    ...
    pyo3::Python::attach(|py| {
        ...
        let system = binding.cast::<SpinSystemWrapper>().unwrap();
...
//     //     .cast::<Vec<(PyCooMatrix, PyCooMatrix, Complex64)>>()
//     //     .unwrap();
//     let comparison =
...
fn test_jordan_wigner() {
    ...
    pyo3::Python::attach(|py| {
        ...
        let number_modes = usize::extract(fs.call_method0("number_modes").unwrap().as_borrowed()).unwrap();
        let number_spins =
