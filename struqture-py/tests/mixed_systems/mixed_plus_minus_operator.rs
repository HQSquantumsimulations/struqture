...
fn new_system(
    ...
    system_type
        ...
        .unwrap()
        .cast::<MixedPlusMinusOperatorWrapper>()
        .unwrap()
        .to_owned()
}
...
fn boson_system_test_set_get() {
    ...
    pyo3::Python::attach(|py| {
        ...
        let system = binding.cast::<MixedPlusMinusOperatorWrapper>().unwrap();
        system
...
fn test_from_mixed_sys() {
    ...
    pyo3::Python::attach(|py| {
        ...
        pp.cast::<MixedOperatorWrapper>().unwrap();
        pp.call_method1(
            "add_operator_product",
            (
                "S0Z:Bc0a1:Fc0a0:",
...
fn test_to_mixed_sys() {
    ...
    pyo3::Python::attach(|py| {
        ...
        sys.cast::<MixedOperatorWrapper>().unwrap();
        sys.call_method1(
            "add_operator_product",
            (
                "S0Z:Bc0a1:Fc0a0:",
