...
fn new_system(
    ...
    system_type
        ...
        .unwrap()
        .cast::<MixedLindbladNoiseOperatorWrapper>()
        .unwrap()
        .to_owned()
}
...
fn boson_system_test_set_get() {
    ...
    pyo3::Python::attach(|py| {
        ...
        let system = new_system
            .call1((number_spins, number_bosons, number_fermions))
            .unwrap();
        system.cast::<MixedLindbladNoiseOperatorWrapper>().unwrap();
        system
...
fn test_from_json_struqture_1() {
    Python::initialize();
    pyo3::Python::attach(|py| {
        let json_string: Bound<pyo3::types::PyString> = pyo3::types::PyString::new(py, "{\"number_spins\":[null],\"number_bosons\":[null],\"number_fermions\":[null],\"operator\":{\"items\":[[\"S0Z:Bc0a0:Fc1a1:\",\"S0Z:Bc0a0:Fc1a1:\",1.0,0.0]],\"n_spins\":1,\"n_bosons\":1,\"n_fermions\":1,\"_struqture_version\":{\"major_version\":1,\"minor_version\":0}}}");
        ...
        let error_json_string: Bound<pyo3::types::PyString> = pyo3::types::PyString::new(py, "{\"number_spins\":[null],\"number_bosons\":[null],\"number_fermions\":[null],\"operator\":{\"items\":[[\"S0Z:Bc0a0:Fc1a1:\",\"S0Z:Bc0a0:Fc1a1:\",1.0,0.0]],\"n_spins\":1,\"n_bosons\":1,\"n_fermions\":1,\"_struqture_version\":{\"major_version\":3-,\"minor_version\":0}}}");
