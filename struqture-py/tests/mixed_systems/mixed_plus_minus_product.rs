...
use struqture::{
    bosons::BosonProduct, fermions::FermionProduct, mixed_systems::MixedPlusMinusProduct,
    spins::PlusMinusProduct,
};
use struqture_py::bosons::BosonProductWrapper;
use struqture_py::fermions::FermionProductWrapper;
use struqture_py::mixed_systems::{MixedPlusMinusProductWrapper, MixedProductWrapper};
use struqture_py::spins::PlusMinusProductWrapper;
...
) -> Bound<MixedPlusMinusProductWrapper> {
    let pp_type = py.get_type_bound::<MixedPlusMinusProductWrapper>();
    pp_type
...
/// Test default function of MixedPlusMinusProductWrapper
#[test]
fn test_default_partialeq_debug_clone() {
    ...
    Python::with_gil(|py| {
        ...
        let pp_wrapper = pp.extract::<MixedPlusMinusProductWrapper>().unwrap();

        // PartialEq
        let helper_ne: bool = MixedPlusMinusProductWrapper::default() != pp_wrapper;
        assert!(helper_ne);
        let helper_eq: bool = MixedPlusMinusProductWrapper::default()
            == MixedPlusMinusProductWrapper::new(vec![], vec![], vec![]).unwrap();
        assert!(helper_eq);
        ...
        let pp_wrapper_0 = pp_0.extract::<MixedPlusMinusProductWrapper>().unwrap();
        let pp_1 = new_pp(
            py,
            vec!["0+".into()],
            vec!["c0a1".into()],
        ...
        let pp_wrapper_1 = pp_1.extract::<MixedPlusMinusProductWrapper>().unwrap();
        ...
        assert_eq!(
            format!("{:?}", MixedPlusMinusProductWrapper { internal: MixedPlusMinusProduct::new(vec![PlusMinusProduct::new().z(0)], vec![BosonProduct::new([0], [1]).unwrap()], vec![FermionProduct::new([0], [0]).unwrap()]) }),
            "MixedPlusMinusProductWrapper { internal: MixedPlusMinusProduct { spins: [PlusMinusProduct { items: [(0, Z)] }], bosons: [BosonProduct { creators: [0], annihilators: [1] }], fermions: [FermionProduct { creators: [0], annihilators: [0] }] } }"
        );
    })
}

/// Test new function of MixedPlusMinusProductWrapper
#[test]
...
/// Test new errors functions of MixedPlusMinusProduct
#[test]
fn test_new_errors() {
    pyo3::prepare_freethreaded_python();
    pyo3::Python::with_gil(|py| {
        let pp = py.get_type_bound::<MixedPlusMinusProductWrapper>();
        ...
        let valid = pp.call1((vec!["0+"], vec!["c0j1"], vec!["c0a0"]));
        assert!(valid.is_err());

        let valid = pp.call1((vec!["0+"], vec!["c0a1"], vec!["c0j0"]));
        assert!(valid.is_err());
    });
}

/// Test from_string function of MixedPlusMinusProduct
#[test]
fn test_from_string() {
    pyo3::prepare_freethreaded_python();
    pyo3::Python::with_gil(|py| {
        let pp: Bound<MixedPlusMinusProductWrapper> = new_pp(
            py,
            vec!["0Z".into()],
            vec!["c0a1".into()],
            vec!["c0a0".into()],
        ...
        let noise_type = py.get_type_bound::<PlusMinusProductWrapper>();
...
/// Test from_string function of MixedPlusMinusProduct - PyValueError
#[test]
...
fn test_to_pp() {
    pyo3::prepare_freethreaded_python();
    pyo3::Python::with_gil(|py| {
        let pmp: Bound<MixedPlusMinusProductWrapper> = new_pp(
            py,
            vec!["0Z".into()],
            vec!["c0a1".into()],
            vec!["c0a0".into()],
        ...
        let pp_type = py.get_type_bound::<MixedProductWrapper>();
        let new_pp = pp_type
            .call1((vec!["0Z"], vec!["c0a1"], vec!["c0a0"]))
            .unwrap();
...
fn test_from_pp() {
    ...
    pyo3::Python::with_gil(|py| {
        ...
        let result = py
            .get_type_bound::<MixedPlusMinusProductWrapper>()
            .call_method1(
                "from_mixed_product",
                (new_pp.downcast::<MixedProductWrapper>().unwrap(),),
            )
...
/// Test hermitian_conjugate and is_natural_hermitian functions of MixedPlusMinusProduct
#[test]
...
/// Test copy and deepcopy functions of MixedPlusMinusProduct
#[test]
...
/// Test to_bincode and from_bincode functions of MixedPlusMinusProduct
#[test]
...
/// Test to_ and from_json functions of MixedPlusMinusProduct
#[test]
...
/// Test hash functions of MixedPlusMinusProduct
#[test]
fn test_hash() {
    pyo3::prepare_freethreaded_python();
    pyo3::Python::with_gil(|py| {
...
fn test_from_pyany_to_struqture_1() {
    ...
    pyo3::Python::with_gil(|py| {
        ...
        let result =
            MixedPlusMinusProductWrapper::from_pyany_to_struqture_1(pp_2.as_ref()).unwrap();
