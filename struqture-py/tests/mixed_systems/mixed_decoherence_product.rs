...
fn new_pp(
    ...
    let pp_type = py.get_type_bound::<MixedDecoherenceProductWrapper>();
    pp_type
...
fn test_new_errors() {
    pyo3::prepare_freethreaded_python();
    pyo3::Python::with_gil(|py| {
        let pp = py.get_type_bound::<MixedDecoherenceProductWrapper>();
...
fn test_from_string() {
    ...
    pyo3::Python::with_gil(|py| {
        ...
        let noise_type = py.get_type_bound::<DecoherenceProductWrapper>();
    ...
    pyo3::Python::with_gil(|py| {
        ...
        let pp_1: struqture_1::mixed_systems::MixedDecoherenceProduct =
            struqture_1::mixed_systems::MixedIndex::new(
                [struqture_1::spins::DecoherenceProduct::from_str("0Z").unwrap()],
        ...
        let result =
            MixedDecoherenceProductWrapper::from_pyany_to_struqture_1(pp_2.as_ref()).unwrap();
